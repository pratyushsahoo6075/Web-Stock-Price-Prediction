...
model = load_model("E:\Latest_stock_price_model.keras")
...
plt.plot(stock_data.index[:splitting_len+100], stock_data['Close'][:splitting_len+100], 'blue', label='Original Test Data')

# Plot the predicted test data
plt.plot(plotting_data.index, plotting_data['Predictions'], 'orange', label='Predicted Test Data')
